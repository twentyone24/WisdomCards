...
extension UIDevice {
    ...
    //: UIDevice.current.screenType.rawValue
    
    var isSmallBounds: Bool { UIScreen.main.nativeBounds.height == 1334 }
    
    var isPlusBounds: Bool { UIScreen.main.nativeBounds.height == 1920 || UIScreen.main.nativeBounds.height == 2208 }
...
// REFERED FROM THIS: https://stackoverflow.com/questions/59569503/swiftui-set-status-bar-color-for-a-specific-view
